...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  3 18:02:32 2022
...
model = sm.tsa.arima.ARIMA(train['value'], order=(0,1,2))
model = model.fit()
#print(model.summary())
...
model2 = sm.tsa.arima.ARIMA(df2['value'], order = (0,1,2))
model2 = model2.fit()
print(df2.tail())
...
index_future_dates = pd.date_range(start = '2019-01-01', end = '2021-01-01', freq = 'YS')
#print(index_future_dates)

pred = model2.predict(start = len(df2), end = len(df2) + 2, typ = 'levels').rename('ARIMA Predictions')
