...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  2 16:43:19 2022
...
df2 = pd.DataFrame({'date': pd.date_range('1946-1-01','2022-01-01', freq = 'YS')}).set_index('date')
df2['value']  = df["Population"].tolist()
...
model = sm.tsa.arima.ARIMA(train['value'], order=(0,2,0))
model = model.fit()
#print(model.summary())
...
model2 = sm.tsa.arima.ARIMA(df2['value'], order = (0,2,0))
model2 = model2.fit()
print(df2.tail())
...
index_future_dates = pd.date_range(start = '2022-01-01', end = '2025-01-01', freq = 'YS')
